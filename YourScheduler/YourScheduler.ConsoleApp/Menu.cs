...
namespace YourScheduler.ConsoleApp
{
    public class Menu
    {
        ...
        private void AddUser()
        {
            ...
            BusinessLogic.Models.User user = new BusinessLogic.Models.User();
            user.Name = _cliHelper.GetStringFromUser("Podaj imię użytkownika");
            user.Surname= _cliHelper.GetStringFromUser("Podaj nazwisko użytkownika");
            user.Email = _cliHelper.GetEmailFromUser("Podaj e-mail");
            user.Displayname = _cliHelper.GetStringFromUser("Podaj login użytkownika");
            user.Password=_cliHelper.GetSecureStringFromUser("Podaj hasło Password");
        ...
        { 
           var users= new List<BusinessLogic.Models.User>();
