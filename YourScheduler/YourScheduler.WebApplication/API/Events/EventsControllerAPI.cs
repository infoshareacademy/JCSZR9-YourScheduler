...
namespace YourScheduler.WebApplication.API.Events
{
    [ApiController]
    ...
    public class EventController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Event>>> GetAllEventsAsyncAPI(int userId)
        {
            try
            {
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<Event>> GetEventByIdAsyncAPI(int userId)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult> AddEventAsyncAPI(Event eventToBeAdded)
        {
            try
            {
