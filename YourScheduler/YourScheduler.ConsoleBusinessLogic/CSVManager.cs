...
namespace YourScheduler.ConsoleBusinessLogic
{
    public class CSVManager
    {
        ...
        {
            string filePath = $"..\\..\\..\\..\\YourScheduler.ConsoleBusinessLogic\\Data\\{usersFileName}";
            return filePath;
        }
        public static string GetEventsFilePath()
        {
            string filePath = $"..\\..\\..\\..\\YourScheduler.ConsoleBusinessLogic\\Data\\{eventsFileName}";
            return filePath;
        }
        public static string GetTeamsFilePath()
        {
            string filePath = $"..\\..\\..\\..\\YourScheduler.ConsoleBusinessLogic\\Data\\{teamsFileName}";
            return filePath;
        }
        public static string GetDataDirectoryPath()
        {
            string filePath = $"..\\..\\..\\..\\YourScheduler.ConsoleBusinessLogic\\Data";
            return filePath;
        }
